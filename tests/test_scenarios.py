...
class ScenarioRouterTest(unittest.TestCase):
    ...
    def test_hr_department_routes_to_react(self) -> None:
    ...
    def test_hr_keyword_routes_to_react(self) -> None:
        decision = self.router.route(
    ...
    def test_risk_query_routes_to_dag_with_three_subtasks(self) -> None:
        decision = self.router.route(
        ...
        self.assertEqual(decision.subtasks[1].tools, ("rag_search",))
